...
# Static Strips
#srun -n 4  --mem-per-cpu=2000M raytrace_mpi -h 1000 -w 1000 -c configs/twhitted.xml -p static_strips_horizontal 
# Static Cycles
# srun -n 4 --mem-per-cpu=2000M raytrace_mpi -h 1000 -w 1000 -c configs/twhitted.xml -p static_cycles_horizontal -cs 10
# Static Blocks
#  srun -n 4 --mem-per-cpu=2000M raytrace_mpi -h 1000 -w 1000 -c configs/twhitted.xml -p static_blocks 
# Dynamic
srun -n 9 raytrace_mpi -h 1000 -w 1000 -c configs/twhitted.xml -p dynamic -bh 15 -bw 15
